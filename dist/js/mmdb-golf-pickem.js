(function() {
	...
	.directive( 'scoreboard', function() {
	 ...
	 angular.module("mmdb.golfPickem").run(["$templateCache", function($templateCache) {$templateCache.put("mmdb-golf-pickem.tmpl.html","<div class=\"container-fluid\">\n    <div class=\"row spacer\">\n        <div class=\"col-md-2\">\n            <div class=\"panel\">\n                <div class=\"btn-group-vertical btn-block sidebar-btn-grp\">\n                    <label class=\"btn btn-large btn-success sidebar-btn\" ng-model=\"golfPickem.display\" uib-btn-radio=\"golfPickem.ENTRIES\">entries</label> <label\n                        class=\"btn btn-large btn-success sidebar-btn\" ng-model=\"golfPickem.display\" uib-btn-radio=\"golfPickem.SCOREBOARD\">scoreboard</label>\n                </div>\n            </div>\n        </div>\n        <div class=\"col-md-10\">\n            <div ng-show=\"golfPickem.display === golfPickem.ENTRIES\">\n                <pickem-entries></pickem-entries>\n            </div>\n            <div ng-show=\"golfPickem.display === golfPickem.SCOREBOARD\">\n                <scoreboard></scoreboard>\n            </div>\n        </div>\n    </div>\n</div>");
