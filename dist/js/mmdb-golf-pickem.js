...
$templateCache.put("scoreboard.tmpl.html","<table class=\"table table-striped table-bordered table-hover table-sm\">\n    <thead>\n        <tr>\n            <th class=\"info text-center h4\">id</th>\n            <th class=\"info text-center h4\">pos</th>\n            <th class=\"info text-center h4\">player</th>\n            <th class=\"info text-center h4\">country</th>\n            <th class=\"info text-center h4\">today</th>\n            <th class=\"info text-center h4\">thru</th>\n            <th class=\"info text-center h4\">to par</th>\n            <th class=\"info text-center h4\">r1</th>\n            <th class=\"info text-center h4\">r2</th>\n            <th class=\"info text-center h4\">r3</th>\n            <th class=\"info text-center h4\">r4</th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr ng-repeat=\"player in scoreboard.players\">\n            <td>{{player.id}}</td>\n            <td>{{player.pos}}</td>\n            <td>{{player.firstname}} {{player.lastname}}</td>\n            <td>{{player.country}}</td>\n            <td>{{player.today}}</td>\n            <td>{{player.thru}}</td>\n            <td>{{player.topar}}</td>\n            <td>{{scoreboard.displayRoundScore(player.r1)}}</td>\n            <td>{{scoreboard.displayRoundScore(player.r2)}}</td>\n            <td>{{scoreboard.displayRoundScore(player.r3)}}</td>\n            <td>{{scoreboard.displayRoundScore(player.r4)}}</td>\n        </tr>\n    </tbody>\n</table>");}]);
}());
